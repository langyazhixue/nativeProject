  ...
  _stackActions_reset = () => {
    const resetAction = StackActions.reset({
      ...
      actions: [
        ...
        NavigationActions.navigate({
          routeName: 'NavigationOptionsStudyDetail1',
        }),
      ],
    });
    ...
    return (
      <SafeAreaView style={layoutStyles.appContainer}>
        <View>
          ...
          <View>
            <Button
              title="NavigationActions_navigate"
              onPress={this._myNavigationActions_navigate}
            />
          </View>

          <View>
            <Button
              title="NavigationActions_back"
              onPress={this._myNavigationActions_back}
            />
          </View>

          <View>
            <Button
              title="NavigationActions_setParams"
              onPress={this._myNavigationActions_setParams}
            />
          </View>

          <View>
            <Text>---------------StackActions -------------------</Text>
          </View>
